...
<head>
    ...
    <title>Kaznet Privacy Policy</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .bg-header-gradient {
            background: #FFFFFF;
            box-shadow: 0 2px 12px 2px rgb(72 72 72 / 4%);
            height: 60px;
        }
...
<body>
    <header>
        <nav class="navbar navbar-dark bg-header-gradient fixed-top">
            <a class="navbar-brand" routerLink="/">
                <!-- <img class="logo my-2" src="/img/kaznet_icon.jpg" alt="Kaznet Logo" style="width: 40px;"> -->
                <img class="logo my-2" src="<?php echo base_url(); ?>/include/assets/img/kaznet_icon.jpg" alt="Kaznet Logo" style="width: 40px;">
            </a>
        </nav>
    </header>
    <div class="priacy">
        <div class="card">
            ...
            <p>This privacy policy applies to the Kaznet app (hereby referred to as "Application") for mobile devices
                that was created by ILRI (hereby referred to as "Service Provider") as a Free service. This service is
            ...
            <p>The Service Provider may use the information you provided to contact you from time to time to provide you
                with important information, required notices and marketing promotions.</p><br>
            <p>For a better experience, while using the Application, the Service Provider may require you to provide us
                ...
                be retained by them and used as described in this privacy policy.</p><br><strong>Third Party
                Access</strong>
            ...
            <p>The Application collects your device's location, which helps the Service Provider determine your
                geographical location. This information may include such as:</p>
            <ul class="list-items">
                <li>Your device's Internet Protocol address (e.g. IP address)</li>
                <li>Your current exact location.</li>
            </ul>
            <p>This Application collects your device's location, which helps the Service Provider determine your
                approximate geographical location and make use of in below ways:</p>
            <ul class="list-items">
                <li>Geolocation Services: The Service Provider utilizes location data to meet the core functionality of
                    the app and perform the location based surveys.</li>
            </ul>
            ...
            <p>The Service Provider will retain User Provided data for as long as you use the Application and for a
                ...
                the Application, please contact them at k.m.shikuku@cgiar.org and they will respond in a reasonable
            ...
            <div><br>
                <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly
                    ...
                    Provider (k.m.shikuku@cgiar.org) so that they will be able to take the necessary actions.</p>
            ...
            <p>The Service Provider is concerned about safeguarding the confidentiality of your information. The Service
                ...
                Provider processes and maintains.</p><br><strong>Changes</strong>
            <p>This Privacy Policy may be updated from time to time for any reason. The Service Provider will notify you
                ...
                changes.</p><br>
            <p>This privacy policy is effective as of 2024-06-10</p><br><strong>Your Consent</strong>
            ...
            <p>If you have any questions regarding privacy while using the Application, or have questions about the
                practices, please contact the Service Provider via email at k.m.shikuku@cgiar.org.</p>
            <hr>
        </div>
</body>
