            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              <div class="card mt-3 border-0">
                  ...
                  <ul class="nav nav-tabs border-bottom-0 bg-transparent mb-3">
                      <li class="nav-item"><a class="nav-link active" href="#Htask" data-toggle="tab">Household Task</a></li>
                      <li class="nav-item"><a class="nav-link" href="#Mtask" data-toggle="tab">Market Task</a></li>
                      <li class="nav-item"><a class="nav-link" href="#Rtask" data-toggle="tab">Rangeland Task</a></li>
                  </ul>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a class="btn btn-outline-dark mt-0" href="<?php echo base_url(); ?>survey/assign_task/<?php echo $survey['type']; ?>/<?php echo $survey['id']; ?>">Assign Task</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                      ...
                      <div class="tab-pane" id="Mtask">
                          <div class="table-responsive">
                              ...
                              <!-- <table class="table tbl_manage_survey"> -->
                                ...
                                <tbody>
                                    <?php foreach ($surveys_mt as $key => $survey) { ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url(); ?>survey/task_contributer/<?php echo $survey['id']; ?>" class="td-color pl-0"><?php echo $survey['title']; ?></a>
                                            <!-- <a href="#" class="td-color pl-0"><?php echo $survey['title']; ?></a> -->
                      ...
                      <div class="tab-pane" id="Rtask">
                          <div class="table-responsive">
                              ...
                              <!-- <table class="table tbl_manage_survey"> -->
                                ...
                                <tbody>
                                    <?php foreach ($surveys_rt as $key => $survey) { ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url(); ?>survey/task_contributer/<?php echo $survey['id']; ?>" class="td-color pl-0"><?php echo $survey['title']; ?></a>
                                            <!-- <a href="#" class="td-color pl-0"><?php echo $survey['title']; ?></a> -->
