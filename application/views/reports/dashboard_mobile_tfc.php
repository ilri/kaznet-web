                                ...
                                <ul class="nav nav-tabs dashboard-nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab"
                                            href="#dashboardUsers">Transect forage conditions</a>
                                    </li>
                                    <!-- <li class="nav-item">
    ...
    // });
        ...
        function getSurveyDeatilsViewT1(){
            ...
            var query_data = {
                ...
                $.ajax({
                    url : "<?php echo base_url(); ?>dashboard/get_users_1_mobile_tfc/",
                    data : query_data,
                    type : "POST",
                    dataType : "JSON",
                    error:function(){	            	
                    ...
                    success:function(response){
                        if(response.status == 1){
                                    ...
                                    <!-- Contributor Graphs start -->
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="card border-0 card-shadow">
                                                    <div class="card-body">
                                                        <h4 class="chart-title">Current Condition (Percentage)</h4>
                                                        <div class="map_height" id="current_condition"
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="card border-0 card-shadow">
                                                    <div class="card-body">
                                                        <h4 class="chart-title">Current Forage Conditions Compare (Percentage)</h4>
                                                        <div class="map_height" id="current_forage_condition"
                                                            style="width:100%;height: 260px;">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="card border-0 card-shadow">
                                                    <div class="card-body">
                                                        <h4 class="chart-title">Dry Fodder</h4>
                                                        <div class="map_height" id="bale_dry_fodder"
                                                            style="width:100%;height: 260px;">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            monthsimple_grouped_barchart('current_condition', response.fielddata_current_condition, response.uai_names, 'Number');
                            monthsimple_grouped_barchart('current_forage_condition', response.fielddata_current_forage_condition, response.uai_names, 'Number');
                            line_graph('bale_dry_fodder', response.fielddata_bale_dry_fodder, response.week_name_list, 'Number');
